export const CONTENT_STATUS_CONFIG: Record<string, { bg: string, dot: string, label: string }> = {
  draft:      { bg: 'bg-gray-100 text-gray-600 border border-gray-200', dot: 'bg-gray-400', label: 'Draft' },
  ...
  published:  { bg: 'bg-cyan-50 text-cyan-700 border border-cyan-100', dot: 'bg-cyan-500', label: 'Published' },
